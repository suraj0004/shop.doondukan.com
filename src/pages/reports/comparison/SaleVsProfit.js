...
class SaleVsProfit extends Component {
  ...
  renderChart() {
    axios.get(UrlService.saleVsProfitUrl(), {
      params: {
  ...
  render() {
    ...
    const options = {
			...
			title: {
				text: "Comparison of Sales & Profit "+this.state.year
			},
			subtitles: [{
    ...
    var table_label = `Save Vs Profit - `;
