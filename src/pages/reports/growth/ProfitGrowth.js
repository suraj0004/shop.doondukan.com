...
class ProfitGrowth extends Component {
  ...
  renderChart() {
    axios.get(UrlService.profitGrowthUrl(), {
      params: {
  ...
  render() {
    ...
    const options = {
          ...
          return {label : item.created_at, y :Number(item.profit)};
        })
			}
			]
		}
