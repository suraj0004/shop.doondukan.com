...
class SetPrice extends Component {
    ...
    if (selectedOption === null) {
      ...
      this.setState(
        ...
        () => {
          ...
          axios
            .post(UrlService.setPriceUrl(), postData, {
            ...
            .then((res) => {
              if (res.data.success) {
                ...
                this.setState({
                  response:
                    "Successfully Added Selling price, Check your Stock list for details.",
  ...
  componentDidMount() {
    ...
    axios
      .get(UrlService.globalStockListUrl(), {
        headers: auth.apiHeader(),
      })
      .then((res) => {
        if (res.data.success) {
          ...
          let options_main = data.main.map((item) => {
            ...
            if (Number(item.purchase_price.price)) {
              option.label = `${option.label}, (Purchased at Rs. ${item.purchase_price.price} /- Per Pec)`;
            }
          ...
          >
            <div className="card-header">
              <h3 className="card-title">
                <strong>Set Product Selling Price</strong>
              </h3>
            </div>
            ...
            <form className="form-horizontal" onSubmit={this.handleSubmit}>
              <div className="card-body">
                <div className="form-group row">
                  <label htmlFor="prduct" className="col-sm-4 col-form-label">
                    Select Product
                  </label>
