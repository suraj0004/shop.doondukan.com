...
class AddSaleReturn extends Component {
  ...
  handleSubmit() {
    this.setState(
      ...
      () => {
        ...
        axios
          .post(UrlService.returnSaleURL(), postData, {
            headers: auth.apiHeader(),
          })
          .then((res) => {
            if (res.data.success) {
  ...
  handleConfirmBillSubmmit = (event) => {
    ...
    this.setState(
      ...
      () => {
        axios
          .get(UrlService.getSaleForReturnUrl() + Number(this.state.bill_id), {
            headers: auth.apiHeader(),
          })
          .then((res) => {
            if (res.data.success) {
            ...
            >
              <div className="card-header">
                <h3 className="card-title">
                  <strong>Return Sold Item</strong>
                </h3>
              </div>
              ...
              <div className="text-right">
                {" "}
                <h2> Total Amount: Rs. {this.state.total} /- </h2>{" "}
              </div>
