...
class SaleReturnList extends Component {
    ...
    componentDidMount(){
        axios.get(UrlService.returnSaleListURL(),{
...
if(res.data.success){
    ...
    render() {
        return (
            <Layout  pathname={this.props.location.pathname} page="Sales Return List" >

<div className="card">
          <div className="card-header">
          <Link to="/addSaleReturn" className="btn btn-outline-primary" ><i className="fa fa-plus"></i> Add Return  </Link>
          </div>
